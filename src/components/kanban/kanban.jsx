...
import { selectTicketListForKanban, selectIsTicketsFetching } from "../../redux/selectors/ticket";
import {
                ...
                >
                  ...
                  <div className="form-group" style={{ marginLeft: 10 }}>
                    <button
                      ...
                      style={{
                        visibility:
                          isFilterActive === true ? "visible" : "hidden",
                        marginRight: 90,
                      }}
                    >
                      Reset filter
...
const KanbanBoard = (props) => {
  ...
  }, [setDraggedOverCol, isFiltersWasReseted, handleOnDragEnd]);
